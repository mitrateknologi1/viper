            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Data Desa / Kelurahan</div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Desa / Kelurahan</h5>
                    ...
                    <div class="modal-body">
                        @component('dashboard.components.formElements.input',
                            [
                                ...
                                'placeholder' => 'Tambah Desa/Kelurahan',
                                'name' => 'nama',
                                'required' => true,
                            ])
                        @endcomponent
...
@push('script')
    <script>
        ...
        $('#btn-tambah').click(function() {
            ...
            $('#modal-tambah-title').html('Tambah Desa / Kelurahan');
        })
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('master-data/desa-kelurahan') }}" + '/' + '{{ $kecamatan->id }}' + '/' +
                    id +
                    '/edit',
                type: "GET",
                data: {
                ...
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Desa / Kelurahan');
        ...
        $('#form-tambah').submit(function(e) {
            ...
            if (aksiTambah == 'tambah') {
                ...
                $.ajax({
                    url: "{{ url('master-data/desa-kelurahan/' . $kecamatan->id) }}" + '/' + idEdit,
                    type: 'PUT',
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.status == 'success') {
    ...
    <script>
        $(document).ready(function() {
            $('#master-wilayah').addClass('active');
        })
